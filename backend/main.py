...
from backend.database.models import PredictionLog, SessionLocal
...
# Initialize SymptomProcessor with known symptoms from the current model dataframe
known_symptoms = []
...
async def predict_health_risk(request: PredictRequest, background_tasks: BackgroundTasks):
    ...
    # If high probability and severity, risk is high.
    # Map probability (0-100) and severity to 0-1
    ...
    # Formula: 50% Symptoms + 30% Demographic + 20% Health Impact
